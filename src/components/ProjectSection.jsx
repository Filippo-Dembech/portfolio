...
export default function ProjectSection({
    ...
    return (
        <motion.section
            ...
            className={`flex flex-col p-7 gap-8 ${className}`}
        >
            <div className="flex flex-col gap-5">
                ...
                <div className="">
                    <ExternalLink
                        className="rounded-lg bg-orange-500 text-orange-50 font-bold p-3 mr-3 transition-colors duration-300 hover:bg-orange-400"
                        href={projectLink}
                    >
                        View Project
                    </ExternalLink>
            ...
            <div className="relative mb-3">
                <img
                    src={img}
                    className="rounded-lg grayscale-100 mix-blend-hard-light"
                    alt="project-img"
                />
